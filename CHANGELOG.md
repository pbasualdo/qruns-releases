...
- **Rebrand**: Officially renamed the application from **Quick Runbooks** to **IT Quick Runbooks**.
- **UI**: Updated application titles in Sidebar, Welcome screens, Footer, and Splash screen.
- **Documentation**: Updated README, Privacy Policy, and Support docs to reflect the new branding.
- **Store**: Consolidated all Store assets and documentation into the `store_release_kit` folder.
