import require$$1$3, { protocol, app, BrowserWindow, net, ipcMain, dialog, shell } from "electron";
...
function requireType$1() {
  ...
  hasRequiredType$1 = 1;
  var YAMLException = requireException$1();
...
var str$1;
var hasRequiredStr$1;
function requireStr$1() {
  if (hasRequiredStr$1) return str$1;
  hasRequiredStr$1 = 1;
  var Type = requireType$1();
  str$1 = new Type("tag:yaml.org,2002:str", {
    kind: "scalar",
...
function require_null$1() {
  ...
  _null$1 = new Type("tag:yaml.org,2002:null", {
    kind: "scalar",
...
function requireBool$1() {
  ...
  bool$1 = new Type("tag:yaml.org,2002:bool", {
    kind: "scalar",
...
function requireFloat$1() {
  ...
  float$1 = new Type("tag:yaml.org,2002:float", {
    kind: "scalar",
...
function requireTimestamp$1() {
  ...
  timestamp$1 = new Type("tag:yaml.org,2002:timestamp", {
    kind: "scalar",
...
function requireOmap$1() {
  ...
  omap$1 = new Type("tag:yaml.org,2002:omap", {
    kind: "sequence",
...
function requirePairs$1() {
  ...
  pairs$1 = new Type("tag:yaml.org,2002:pairs", {
    kind: "sequence",
...
function requireJsYaml$2() {
  ...
  var loader2 = requireLoader$1();
  var dumper2 = requireDumper$1();
  function deprecated(name) {
    return function() {
      throw new Error("Function " + name + " is deprecated and cannot be used.");
    };
  }
  jsYaml$2.Type = requireType$1();
  jsYaml$2.Schema = requireSchema$1();
  jsYaml$2.FAILSAFE_SCHEMA = requireFailsafe$1();
  jsYaml$2.JSON_SCHEMA = requireJson$2();
  jsYaml$2.CORE_SCHEMA = requireCore$1();
  ...
  jsYaml$2.YAMLException = requireException$1();
  jsYaml$2.MINIMAL_SCHEMA = requireFailsafe$1();
...
function requireStringify() {
  ...
  stringify = function(file2, data, options2) {
...
function requireExcerpt() {
  ...
  const defaults2 = requireDefaults();
  excerpt = function(file2, options2) {
    const opts = defaults2(options2);
    if (file2.data == null) {
      file2.data = {};
    }
...
function requireGrayMatter() {
  ...
  function matter2(input, options2) {
    ...
    const cached = matter2.cache[file2.content];
    if (!options2) {
      if (cached) {
  ...
  function parseMatter(file2, options2) {
    ...
    if (block === "") {
      ...
      file2.data = parse2(file2.language, file2.matter, opts);
    }
    if (closeIndex === len) {
      file2.content = "";
    } else {
...
function requireFs() {
  ...
  (function(exports$12) {
    ...
    Object.assign(exports$12, fs2);
    api.forEach((method) => {
      exports$12[method] = u(fs2[method]);
    });
    exports$12.exists = function(filename, callback) {
    ...
    exports$12.read = function(fd, buffer, offset, length, position, callback) {
      if (typeof callback === "function") {
    ...
    exports$12.write = function(fd, buffer, ...args) {
    ...
    if (typeof fs2.writev === "function") {
      exports$12.writev = function(fd, buffers, ...args) {
        if (typeof args[args.length - 1] === "function") {
    ...
    if (typeof fs2.realpath.native === "function") {
      exports$12.realpath.native = u(fs2.realpath.native);
    } else {
      process.emitWarning(
...
function requireMakeDir() {
  ...
  makeDir.makeDir = async (dir, options2) => {
    checkPath(dir);
  ...
  makeDir.makeDirSync = (dir, options2) => {
    checkPath(dir);
...
function requireJsonfile$1() {
  ...
  async function _readFile(file2, options2 = {}) {
    ...
    let data = await universalify2.fromCallback(fs2.readFile)(file2, options2);
    data = stripBom(data);
    let obj;
    try {
  ...
  async function _writeFile(file2, obj, options2 = {}) {
    const fs2 = options2.fs || _fs;
    const str2 = stringify2(obj, options2);
    await universalify2.fromCallback(fs2.writeFile)(file2, str2, options2);
  }
...
function requireOutputJson() {
  ...
  async function outputJson(file2, data, options2 = {}) {
    const str2 = stringify2(data, options2);
...
function requireBrowser() {
  ...
  (function(module2, exports$12) {
    ...
    function load() {
      let r;
      try {
        r = exports$12.storage.getItem("debug") || exports$12.storage.getItem("DEBUG");
      } catch (error2) {
      }
    ...
    module2.exports = requireCommon$1()(exports$12);
...
function requireNode() {
  ...
  (function(module2, exports$12) {
    ...
    exports$12.load = load;
    exports$12.useColors = useColors;
    exports$12.destroy = util2.deprecate(
      () => {
      },
      "Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."
    );
    exports$12.colors = [6, 2, 3, 4, 5, 1];
    try {
    ...
    exports$12.inspectOpts = Object.keys(process.env).filter((key) => {
    ...
    function useColors() {
      return "colors" in exports$12.inspectOpts ? Boolean(exports$12.inspectOpts.colors) : tty.isatty(process.stderr.fd);
    }
    function formatArgs(args) {
    ...
    function getDate() {
      if (exports$12.inspectOpts.hideDate) {
        return "";
      }
      return (/* @__PURE__ */ new Date()).toISOString() + " ";
    }
    function log(...args) {
      return process.stderr.write(util2.formatWithOptions(exports$12.inspectOpts, ...args) + "\n");
    }
    function save(namespaces) {
      if (namespaces) {
    ...
    function init(debug) {
      debug.inspectOpts = {};
      const keys = Object.keys(exports$12.inspectOpts);
      for (let i = 0; i < keys.length; i++) {
        debug.inspectOpts[keys[i]] = exports$12.inspectOpts[keys[i]];
      }
    }
    module2.exports = requireCommon$1()(exports$12);
    const { formatters } = module2.exports;
...
`));
    ...
    static reconstructOriginalUrl(options2) {
      const protocol2 = options2.protocol || "https:";
...
function requireRetry() {
  ...
  retry.retry = retry$1;
  const CancellationToken_1 = requireCancellationToken();
  async function retry$1(task, options2) {
    var _a;
    ...
    try {
      ...
      if (await Promise.resolve((_a = shouldRetry === null || shouldRetry === void 0 ? void 0 : shouldRetry(error2)) !== null && _a !== void 0 ? _a : true) && retryCount > 0 && !cancellationToken.cancelled) {
        ...
        return await retry$1(task, { ...options2, retries: retryCount - 1, attempt: attempt + 1 });
      } else {
        throw error2;
      }
    }
...
function requireOut() {
  ...
  (function(exports$12) {
    ...
    exports$12.CURRENT_APP_PACKAGE_FILE_NAME = exports$12.CURRENT_APP_INSTALLER_FILE_NAME = exports$12.XElement = exports$12.parseXml = exports$12.UUID = exports$12.parseDn = exports$12.retry = exports$12.githubTagPrefix = exports$12.githubUrl = exports$12.getS3LikeProviderBaseUrl = exports$12.ProgressCallbackTransform = exports$12.MemoLazy = exports$12.safeStringifyJson = exports$12.safeGetHeader = exports$12.parseJson = exports$12.HttpExecutor = exports$12.HttpError = exports$12.DigestTransform = exports$12.createHttpError = exports$12.configureRequestUrl = exports$12.configureRequestOptionsFromUrl = exports$12.configureRequestOptions = exports$12.newError = exports$12.CancellationToken = exports$12.CancellationError = void 0;
    exports$12.asArray = asArray;
    var CancellationToken_1 = requireCancellationToken();
    Object.defineProperty(exports$12, "CancellationError", { enumerable: true, get: function() {
      return CancellationToken_1.CancellationError;
    } });
    Object.defineProperty(exports$12, "CancellationToken", { enumerable: true, get: function() {
      return CancellationToken_1.CancellationToken;
    } });
    var error_1 = requireError();
    Object.defineProperty(exports$12, "newError", { enumerable: true, get: function() {
      return error_1.newError;
    } });
    var httpExecutor_1 = requireHttpExecutor();
    Object.defineProperty(exports$12, "configureRequestOptions", { enumerable: true, get: function() {
      return httpExecutor_1.configureRequestOptions;
    } });
    Object.defineProperty(exports$12, "configureRequestOptionsFromUrl", { enumerable: true, get: function() {
      return httpExecutor_1.configureRequestOptionsFromUrl;
    } });
    Object.defineProperty(exports$12, "configureRequestUrl", { enumerable: true, get: function() {
      return httpExecutor_1.configureRequestUrl;
    } });
    Object.defineProperty(exports$12, "createHttpError", { enumerable: true, get: function() {
      return httpExecutor_1.createHttpError;
    } });
    Object.defineProperty(exports$12, "DigestTransform", { enumerable: true, get: function() {
      return httpExecutor_1.DigestTransform;
    } });
    Object.defineProperty(exports$12, "HttpError", { enumerable: true, get: function() {
      return httpExecutor_1.HttpError;
    } });
    Object.defineProperty(exports$12, "HttpExecutor", { enumerable: true, get: function() {
      return httpExecutor_1.HttpExecutor;
    } });
    Object.defineProperty(exports$12, "parseJson", { enumerable: true, get: function() {
      return httpExecutor_1.parseJson;
    } });
    Object.defineProperty(exports$12, "safeGetHeader", { enumerable: true, get: function() {
      return httpExecutor_1.safeGetHeader;
    } });
    Object.defineProperty(exports$12, "safeStringifyJson", { enumerable: true, get: function() {
      return httpExecutor_1.safeStringifyJson;
    } });
    var MemoLazy_1 = requireMemoLazy();
    Object.defineProperty(exports$12, "MemoLazy", { enumerable: true, get: function() {
      return MemoLazy_1.MemoLazy;
    } });
    var ProgressCallbackTransform_1 = requireProgressCallbackTransform();
    Object.defineProperty(exports$12, "ProgressCallbackTransform", { enumerable: true, get: function() {
      return ProgressCallbackTransform_1.ProgressCallbackTransform;
    } });
    var publishOptions_1 = requirePublishOptions();
    Object.defineProperty(exports$12, "getS3LikeProviderBaseUrl", { enumerable: true, get: function() {
      return publishOptions_1.getS3LikeProviderBaseUrl;
    } });
    Object.defineProperty(exports$12, "githubUrl", { enumerable: true, get: function() {
      return publishOptions_1.githubUrl;
    } });
    Object.defineProperty(exports$12, "githubTagPrefix", { enumerable: true, get: function() {
    ...
    Object.defineProperty(exports$12, "parseDn", { enumerable: true, get: function() {
      return rfc2253Parser_1.parseDn;
    } });
    var uuid_1 = requireUuid();
    Object.defineProperty(exports$12, "UUID", { enumerable: true, get: function() {
      return uuid_1.UUID;
    } });
    var xml_1 = requireXml();
    Object.defineProperty(exports$12, "parseXml", { enumerable: true, get: function() {
      return xml_1.parseXml;
    } });
    Object.defineProperty(exports$12, "XElement", { enumerable: true, get: function() {
      return xml_1.XElement;
    } });
    exports$12.CURRENT_APP_INSTALLER_FILE_NAME = "installer.exe";
    exports$12.CURRENT_APP_PACKAGE_FILE_NAME = "package.7z";
    function asArray(v) {
      if (v == null) {
        return [];
...
function requireSnippet() {
  ...
  function makeSnippet(mark2, options2) {
    ...
    for (i = 1; i <= options2.linesBefore; i++) {
      ...
      result = common2.repeat(" ", options2.indent) + padStart((mark2.line - i + 1).toString(), lineNoLength) + " | " + line.str + "\n" + result;
    }
    line = getLine(mark2.buffer, lineStarts[foundLineNo], lineEnds[foundLineNo], mark2.position, maxLineLength);
    result += common2.repeat(" ", options2.indent) + padStart((mark2.line + 1).toString(), lineNoLength) + " | " + line.str + "\n";
...
function requireRe() {
  ...
  (function(module2, exports$12) {
    ...
    const src2 = exports$12.src = [];
    const safeSrc = exports$12.safeSrc = [];
    const t = exports$12.t = {};
    let R = 0;
...
function requireParse() {
  ...
  const parse2 = (version, options2, throwErrors = false) => {
    if (version instanceof SemVer) {
      return version;
    }
    try {
...
function requireRange() {
  ...
  const testSet = (set2, version, options2) => {
...
function requireLodash_isequal() {
  ...
  (function(module2, exports$12) {
    ...
    var freeExports = exports$12 && !exports$12.nodeType && exports$12;
...
function requireElectronHttpExecutor() {
  ...
  (function(exports$12) {
    Object.defineProperty(exports$12, "__esModule", { value: true });
    exports$12.ElectronHttpExecutor = exports$12.NET_SESSION_NAME = void 0;
    exports$12.getNetSession = getNetSession;
    const builder_util_runtime_1 = requireOut();
    exports$12.NET_SESSION_NAME = "electron-updater";
    function getNetSession() {
      return require$$1$3.session.fromPartition(exports$12.NET_SESSION_NAME, {
        cache: false
      });
    }
    ...
    exports$12.ElectronHttpExecutor = ElectronHttpExecutor;
...
function requireDataSplitter() {
  ...
  let DataSplitter$1 = class DataSplitter extends stream_1.Writable {
    constructor(out2, options2, partIndexToTaskIndex, boundary, partIndexToLength, finishHandler) {
      super();
      this.out = out2;
      this.options = options2;
...
function requireMultipleRangeDownloader() {
  ...
  function doExecuteTasks(differentialDownloader, options2, out2, resolve, reject) {
    ...
    for (let i = options2.start; i < options2.end; i++) {
      const task = options2.tasks[i];
    ...
    if (partCount <= 1) {
      const w = (index) => {
        ...
        if (task.kind === downloadPlanBuilder_1.OperationKind.COPY) {
          (0, DataSplitter_1.copyData)(task, out2, options2.oldFileFd, reject, () => w(index));
        } else {
    ...
    const request = differentialDownloader.httpExecutor.createRequest(requestOptions, (response) => {
      ...
      const dicer = new DataSplitter_1.DataSplitter(out2, options2, partIndexToTaskIndex, m[1] || m[2], partIndexToLength, resolve);
...
function requireTypes() {
  ...
  (function(exports$12) {
    Object.defineProperty(exports$12, "__esModule", { value: true });
    exports$12.UpdaterSignal = exports$12.UPDATE_DOWNLOADED = exports$12.DOWNLOAD_PROGRESS = exports$12.CancellationToken = void 0;
    exports$12.addHandler = addHandler;
    const builder_util_runtime_1 = requireOut();
    Object.defineProperty(exports$12, "CancellationToken", { enumerable: true, get: function() {
      return builder_util_runtime_1.CancellationToken;
    } });
    exports$12.DOWNLOAD_PROGRESS = "download-progress";
    exports$12.UPDATE_DOWNLOADED = "update-downloaded";
    class UpdaterSignal {
      constructor(emitter) {
      ...
      progress(handler) {
        addHandler(this.emitter, exports$12.DOWNLOAD_PROGRESS, handler);
      }
      updateDownloaded(handler) {
        addHandler(this.emitter, exports$12.UPDATE_DOWNLOADED, handler);
      }
      updateCancelled(handler) {
        addHandler(this.emitter, "update-cancelled", handler);
      }
    }
    exports$12.UpdaterSignal = UpdaterSignal;
...
function requireMain() {
  ...
  (function(exports$12) {
    ...
    var __exportStar = main$1 && main$1.__exportStar || function(m, exports$13) {
      for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports$13, p)) __createBinding(exports$13, m, p);
    };
    Object.defineProperty(exports$12, "__esModule", { value: true });
    exports$12.NsisUpdater = exports$12.MacUpdater = exports$12.RpmUpdater = exports$12.PacmanUpdater = exports$12.DebUpdater = exports$12.AppImageUpdater = exports$12.Provider = exports$12.NoOpLogger = exports$12.AppUpdater = exports$12.BaseUpdater = void 0;
    const fs_extra_1 = /* @__PURE__ */ requireLib();
    const path2 = require$$1$1;
    var BaseUpdater_1 = requireBaseUpdater();
    Object.defineProperty(exports$12, "BaseUpdater", { enumerable: true, get: function() {
      return BaseUpdater_1.BaseUpdater;
    } });
    var AppUpdater_1 = requireAppUpdater();
    Object.defineProperty(exports$12, "AppUpdater", { enumerable: true, get: function() {
      return AppUpdater_1.AppUpdater;
    } });
    Object.defineProperty(exports$12, "NoOpLogger", { enumerable: true, get: function() {
      return AppUpdater_1.NoOpLogger;
    } });
    var Provider_1 = requireProvider();
    Object.defineProperty(exports$12, "Provider", { enumerable: true, get: function() {
      return Provider_1.Provider;
    } });
    var AppImageUpdater_1 = requireAppImageUpdater();
    Object.defineProperty(exports$12, "AppImageUpdater", { enumerable: true, get: function() {
      return AppImageUpdater_1.AppImageUpdater;
    } });
    var DebUpdater_1 = requireDebUpdater();
    Object.defineProperty(exports$12, "DebUpdater", { enumerable: true, get: function() {
      return DebUpdater_1.DebUpdater;
    } });
    var PacmanUpdater_1 = requirePacmanUpdater();
    Object.defineProperty(exports$12, "PacmanUpdater", { enumerable: true, get: function() {
      return PacmanUpdater_1.PacmanUpdater;
    } });
    var RpmUpdater_1 = requireRpmUpdater();
    Object.defineProperty(exports$12, "RpmUpdater", { enumerable: true, get: function() {
      return RpmUpdater_1.RpmUpdater;
    } });
    var MacUpdater_1 = requireMacUpdater();
    Object.defineProperty(exports$12, "MacUpdater", { enumerable: true, get: function() {
      return MacUpdater_1.MacUpdater;
    } });
    var NsisUpdater_1 = requireNsisUpdater();
    Object.defineProperty(exports$12, "NsisUpdater", { enumerable: true, get: function() {
      return NsisUpdater_1.NsisUpdater;
    } });
    __exportStar(requireTypes(), exports$12);
    let _autoUpdater;
    ...
    Object.defineProperty(exports$12, "autoUpdater", {
      enumerable: true,
      get: () => {
...
const RENDERER_DIST = path.join(process.env.APP_ROOT, "dist_renderer");
...
function createSplashWindow() {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    splash.loadFile(splashPath).catch(() => {
      splash == null ? void 0 : splash.loadURL('data:text/html;charset=utf-8,<html><body style="background:#0F172A;color:white;display:flex;justify-content:center;align-items:center;"><h1>Quick Runbooks</h1></body></html>');
    });
  }
  splash.center();
}
...
function ensureSourcesExist(sources) {
  sources.forEach((dir) => {
...
function getAllFiles(dirPath, arrayOfFiles = []) {
  ...
  files.forEach((file2) => {
    ...
    if (fs$1.statSync(fullPath).isDirectory()) {
      if (file2 !== ".git" && file2 !== "node_modules" && file2 !== "dist" && file2 !== "build") {
        getAllFiles(fullPath, arrayOfFiles);
      }
    } else {
      if (file2.toLowerCase().endsWith(".md")) {
...
function installExamples(targetDir) {
  try {
    ...
    let count = 0;
    if (fs$1.existsSync(examplesPath)) {
      const exampleFiles = fs$1.readdirSync(examplesPath);
      exampleFiles.forEach((file2) => {
        const srcPath = path.join(examplesPath, file2);
        const destPath = path.join(targetDir, file2);
        if (!fs$1.existsSync(destPath)) {
          fs$1.copyFileSync(srcPath, destPath);
          console.log(`Copied example: ${file2}`);
          count++;
        }
      });
...
function parseRunbookFile(filePath) {
  try {
...
function parseMarkdownSteps(content) {
  const steps = [];
...
function serializeToMarkdown(runbook) {
...
`;
          ...
          c.items.forEach((it) => stepContent += `- ${it}
`);
          stepContent += "\n";
        } else if (c.type === "text") {
          stepContent += c.text + "\n\n";
...
ipcMain.handle("remove-source", async (_, pathToRemove) => {
  const config = getConfig();
  config.sources = config.sources.filter((s) => s !== pathToRemove);
  saveConfig(config);
  return { success: true, sources: config.sources };
});
...
ipcMain.handle("save-runbook", async (_, runbook) => {
  try {
    ...
    if (!fs$1.existsSync(targetDir)) fs$1.mkdirSync(targetDir, { recursive: true });
    ...
    console.error("Error saving runbook:", error2);
  ...
  try {
    ...
    if (runbook.sourcePath) {
      ...
      for (const dir of sources) {
        ...
        if (fs$1.existsSync(mdPath)) {
          targetFile = mdPath;
          break;
        }
      }
    }
    if (targetFile && fs$1.existsSync(targetFile)) {
      fs$1.unlinkSync(targetFile);
      return { success: true };
    }
    return { success: false, error: "File not found" };
  } catch (error2) {
    console.error("Error deleting runbook:", error2);
    return { success: false, error: error2.message };
  }
});
ipcMain.handle("clone-repository", async (_, url, options2 = {}) => {
  try {
    ...
    if (!fs$1.existsSync(reposDir)) fs$1.mkdirSync(reposDir, { recursive: true });
    ...
    return new Promise((resolve) => {
      ...
      exec(command, execOptions, (error2, _stdout, stderr) => {
        let success = false;
        if (interactive) {
          if (fs$1.existsSync(targetDir) && fs$1.readdirSync(targetDir).length > 0) {
            success = true;
          }
        } else if (!error2) {
          success = true;
        ...
        if (success) {
          ...
          if (fs$1.existsSync(qrunPath) && fs$1.statSync(qrunPath).isDirectory()) {
...
autoUpdater.on("update-available", (info) => {
  ...
  win == null ? void 0 : win.webContents.send("update-available", info);
});
autoUpdater.on("update-not-available", (info) => {
  console.log("Update not available:", info);
  win == null ? void 0 : win.webContents.send("update-not-available", info);
});
autoUpdater.on("error", (err) => {
  console.error("Update error:", err);
  win == null ? void 0 : win.webContents.send("update-error", err.toString());
});
...
autoUpdater.on("update-downloaded", (info) => {
  ...
  win == null ? void 0 : win.webContents.send("update-downloaded", info);
});
const TEMPLATE_MD = `---
title: New Runbook
id: new-runbook
...
ipcMain.handle("refresh-sources", async () => {
  try {
    ...
    const results = [];
    for (const dir of sources) {
      if (fs$1.existsSync(path.join(dir, ".git"))) {
        try {
          await new Promise((resolve, reject) => {
            exec("git pull", { cwd: dir }, (error2, stdout, stderr) => {
              if (error2) {
                results.push({ source: dir, success: false, error: stderr || error2.message });
                reject(error2);
                return;
              }
...
ipcMain.handle("import-file", async () => {
  ...
  try {
    ...
    if (filePaths && filePaths.length > 0) {
      ...
      const config = getConfig();
      const targetDir = config.sources[0];
      if (!fs$1.existsSync(targetDir)) {
        fs$1.mkdirSync(targetDir, { recursive: true });
      }
      const fileName = path.basename(srcFile);
      const targetFile = path.join(targetDir, fileName);
      fs$1.copyFileSync(srcFile, targetFile);
      return { success: true };
    }
...
ipcMain.handle("qrun:pick-image", async (_, targetDir) => {
  ...
  try {
    ...
    if (filePaths && filePaths.length > 0) {
      ...
      if (!fs$1.existsSync(assetsDir)) {
        fs$1.mkdirSync(assetsDir, { recursive: true });
      }
